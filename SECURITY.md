...
Do not include VK tokens, private media, personal paths, or other sensitive information in a public issue.

Use GitHub's private security advisory for this repository when available. For ordinary non-sensitive bugs, create a GitHub issue with reproduction steps, the MediaTidy version, and the Windows version.
