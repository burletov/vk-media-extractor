...
internal sealed class QuarantineService
{
    ...
    private const string FolderPattern = ".MediaExtractorForVK_Quarantine_*";
        ...
        CancellationToken cancellationToken)
    {
        var quarantineRoot = Path.Combine(
            rootPath,
            $".MediaExtractorForVK_Quarantine_{DateTime.Now:yyyyMMdd_HHmmss}");
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            var latestJournal = Directory
                .GetDirectories(rootPath, FolderPattern, SearchOption.TopDirectoryOnly)
