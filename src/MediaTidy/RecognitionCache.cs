...
{
    private const string CacheFileName = ".MediaTidy_RecognitionCache.json";
    private const string LegacyCacheFileName = ".PhotoCleaner_RecognitionCache.json";
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var sourcePath = File.Exists(path)
                ? path
                : Path.Combine(rootPath, LegacyCacheFileName);
